          ...
          <motion.div key={section} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.13 }}>
            ...
            {section === "admin" && isAdmin && (
              <div style={{ maxWidth: "600px" }}>
                <h2 style={{ fontSize: "15px", fontWeight: 700, color: C.text, margin: "0 0 3px" }}>Admin Panel</h2>
                <p style={{ fontSize: "11px", color: C.textSub, margin: "0 0 20px" }}>Manage users and moderate content</p>
                {adminLoading ? (
